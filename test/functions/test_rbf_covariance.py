...
class TestRBFCovariance(unittest.TestCase):
    def test_forward(self):
        ...
        res = Lgpytorch.functions.RBFCovariance.apply(x1, x2, lengthscale, sq_dist_func)
    ...
    def test_backward(self):
        ...
        f = lambda x1, x2, l: Lgpytorch.functions.RBFCovariance.apply(x1, x2, l, sq_dist_func)
        try:
